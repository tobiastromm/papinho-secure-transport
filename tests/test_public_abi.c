...
A(api,PST_API_VERSION==0x00020100UL);A(lib,PST_LIBRARY_VERSION==0x00000600UL);
A(role,offsetof(PST_CONNECTION_CONFIG,role)==8);A(known,PST_CAP_KNOWN_MASK==0x0003ffffUL);A(sni_compat_zero,PST_SNI_MODE_COMPAT==0UL);
