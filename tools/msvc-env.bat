...
@echo off
if not "%PST_MSVC_19_51_VCVARS64%"=="" goto validate_path
...
for /f "usebackq tokens=*" %%I in (`"%PST_VSWHERE%" -latest -products * -requires Microsoft.VisualStudio.Component.VC.Tools.x86.x64 -property installationPath`) do set PST_MSVC_19_51_VSINSTALL=%%I
if "%PST_MSVC_19_51_VSINSTALL%"=="" goto missing_installation
set PST_MSVC_19_51_VCVARS64=%PST_MSVC_19_51_VSINSTALL%\VC\Auxiliary\Build\vcvars64.bat
:validate_path
if not exist "%PST_MSVC_19_51_VCVARS64%" goto missing
call "%PST_MSVC_19_51_VCVARS64%"
...
exit /b 5
:missing
echo MSVC 19.51 x64 bootstrap missing: %PST_MSVC_19_51_VCVARS64%
echo Set PST_MSVC_19_51_VCVARS64 to a valid vcvars64.bat.
exit /b 2
:wrong_arch
