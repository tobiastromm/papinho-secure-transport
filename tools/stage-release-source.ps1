...
foreach ($file in @(".gitattributes", "README.md", "LICENSE", "THIRD_PARTY_NOTICES.md", "Makefile.vc6", "Makefile.msvc", "Makefile.openssl.msvc", "Makefile.combined.msvc")) {
...
$required = @(
    ...
    "src\pst_runtime.c",
    "tools\build-vc6.bat",
    "tools\build-win32-x64-msvc-19.51-schannel.bat",
