...
Validated scenarios currently include **TLS 1.2 and TLS 1.3 on Windows NT 4.0 SP6 x86 through RetroZilla NSS**, **TLS 1.2 on Windows 10 build 19045 x64 through Schannel**, and **TLS 1.2 and TLS 1.3 on Windows 10 build 19045 x64 through OpenSSL**.
