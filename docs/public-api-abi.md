...
API remains `2.1.0`; SPI remains `3.0`. M10 completed physical NT4 validation, clean-machine package consumers, deterministic packaging and release verification for the published 0.6.0 baseline.
