...
At that historical checkpoint, the modern failure matrix was therefore not fully ready and Phase 7.B remained in progress independently of the NT4 execution requirement.
...
At that historical checkpoint, the next real NT4 run was abrupt_close. Phase 7.B remained in progress because the abrupt-close classification blocker was then unresolved.
