...
The four static 0.6.1 SDKs preserve file-level source availability through papinho-secure-transport-0.6.1-src.zip. Third-party files retain their independent terms and are not relicensed as PST code. The published 0.6.0 package and its corresponding source remain immutable historical release artifacts.
