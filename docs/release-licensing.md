...
The five static 0.6.2 SDKs preserve file-level source availability through papinho-secure-transport-0.6.2-src.zip. Third-party files retain their independent terms and are not relicensed as PST code. Published 0.6.0 and 0.6.1 packages and their corresponding source remain immutable historical release artifacts.
