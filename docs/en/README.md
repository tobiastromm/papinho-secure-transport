...
| Validated system / target | Provider | TLS 1.2 | TLS 1.3 | System trust |
|---|---|:---:|:---:|:---:|
...
| Windows 11 | — | ⏳ validation pending | ⏳ validation pending | ⏳ |
| Windows Server | — | ⏳ validation pending | ⏳ validation pending | ⏳ |
