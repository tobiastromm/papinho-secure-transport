...
Output: `build\win32-x86-vc6-retrozilla-nss\papinho_secure_transport.lib`.
...
Output: `build\win32-x64-msvc-19.51-schannel\papinho_secure_transport.lib`.
...
Output: `build\win32-x64-msvc-19.51-openssl3\papinho_secure_transport.lib`,
...
Output: `build\win32-x64-msvc-19.51-schannel-openssl3\papinho_secure_transport.lib`,
