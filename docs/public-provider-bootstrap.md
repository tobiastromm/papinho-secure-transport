...
Status: Phase 9.D0-A architecture, 9.D0-B implementation/validation, and the limited 9.B public-bootstrap addendum are complete. API 1.3.0 is frozen; SPI 2.4 is unchanged; library 0.4.0 is the compatible Phase 9 release promotion. Phase 9 is complete and the unpublished release candidate is ready for owner approval.
