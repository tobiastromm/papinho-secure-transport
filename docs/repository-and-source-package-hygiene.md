...
- `build-msvc-19.51.md`, `build-openssl.md`, `build-retrozilla-nss.md`, `build-vc6.md`
...
- providers: `cross-backend-validation.md`, `openssl-provider.md`, `openssl-system-trust.md`, `provider-evolution.md`, `provider-spi.md`
...
- release: `mpl-2.0-license-audit.md`, `public-api-abi.md`, `public-provider-bootstrap.md`, `release-licensing.md`, `release-packaging.md`, `repository-and-source-package-hygiene.md`, `roadmap.md`
...
- `codex/phase-history/phase9-release-scope.md`: Phase 9.A scope and handoff record superseded by the final release documents.
- `codex/phase-history/openssl-extension-closure.md`: post-Phase-8 three-provider closure record.
- `codex/phase-history/openssl-failure-hardening.md`: OSSL-E failure-hardening closure record.
...
- `win32-x64-msvc-19.51-schannel-openssl3` — official optional candidate, never implied to be default or recommended.
