...
#define PST_OSSL_WINDOWS_TRUST_CERTIFICATE_UNTRUSTED 1UL
#define PST_OSSL_WINDOWS_TRUST_CERTIFICATE_INVALID 2UL
#define PST_OSSL_WINDOWS_TRUST_INTERNAL_FAILURE 3UL
